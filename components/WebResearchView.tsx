...
// Sub-components
import { WebResearchAgents } from './research/WebResearchAgents';
import { WebResearchResult } from './research/WebResearchResult';
import { ResearchNoteList } from './research/ResearchNoteList';
import { ResearchNoteDetail } from './research/ResearchNoteDetail';
...
const WebResearchView: React.FC<Props> = ({ customer, onUpdate }) => {
  ...
  const executeSearch = async (searchQuery: string, scenarioId?: string) => {
